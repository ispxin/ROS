...
-- Records of ros_app
-- ----------------------------
INSERT INTO `ros_app` VALUES ('1', '1', '我的博客', '/ros/Public/Home/images/app/clover.png', '500', '300', 'http://www.wangyingran.com', '1', '1', null, 'ispxin', '1386829188');
INSERT INTO `ros_app` VALUES ('2', '1', '我的博客', '/ros/Public/Home/images/app/clover.png', '500', '300', 'http://www.wangyingran.com', '1', '1', null, 'ispxin', '1386829188');
INSERT INTO `ros_app` VALUES ('3', '5', 'QQ音乐', '/ros/Public/Home/images/app/clover.png', '500', '300', 'http://www.wangyingran.com', '1', '1', '', 'ispxin', '1386829188');
INSERT INTO `ros_app` VALUES ('4', '1', '读书天下', 'http://4.web.qstatic.com/webqqpic/pubapps/2/2534/images/big.png', '715', '530', 'http://www.dooland.com/magazine/api/q+/flash.php', '0', '1', 0xE8AFBBE4B9A6E5A4A9E4B88BE68F8FE8BFB0E5958AEFBD9E, '平台提供', '1386829188');
INSERT INTO `ros_app` VALUES ('5', '1', '腾讯微博', 'http://2.web.qstatic.com/webqqpic/pubapps/0/2/images/big.png', '1000', '800', 'http://t.qq.com', '1', '1', 0xE885BEE8AEAFE5BEAEE58D9AE7AE80E4BB8BE593A6EFBD9E7E7E7E, '平台提供', '1386829188');
...
-- Records of ros_user
-- ----------------------------
INSERT INTO `ros_user` VALUES ('1', 'guest@ros.com', '21232f297a57a5a743894a0e4a801fc3', '1386829188', '0');
INSERT INTO `ros_user` VALUES ('2', 'ispxin@vip.qq.com', '21232f297a57a5a743894a0e4a801fc3', '1386829188', '0');
...
-- ----------------------------
-- Table structure for `ros_userapp`
-- ----------------------------
DROP TABLE IF EXISTS `ros_userapp`;
CREATE TABLE `ros_userapp` (
  `id` int(11) NOT NULL auto_increment,
...
-- ----------------------------
-- Records of ros_userapp
-- ----------------------------
INSERT INTO `ros_userapp` VALUES ('78', '1', '4', '1', '3');
INSERT INTO `ros_userapp` VALUES ('79', '1', '5', '1', '3');
INSERT INTO `ros_userapp` VALUES ('102', '1', '1', '1', '2');
INSERT INTO `ros_userapp` VALUES ('108', '1', '5', '1', '2');
INSERT INTO `ros_userapp` VALUES ('107', '1', '4', '1', '2');
INSERT INTO `ros_userapp` VALUES ('80', '1', '3', '2', '3');
INSERT INTO `ros_userapp` VALUES ('103', '1', '2', '1', '2');
INSERT INTO `ros_userapp` VALUES ('105', '1', '3', '1', '2');
