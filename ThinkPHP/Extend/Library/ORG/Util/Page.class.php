...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('header'=>'条记录','prev'=>'&laquo;','next'=>'&raquo;','first'=>'第一页','last'=>'最后一页','theme'=>' <li><span>%totalRow% %header% %nowPage%/%totalPage% 页 %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%</span></li>');
    // 默认分页变量名
    protected $varPage;
